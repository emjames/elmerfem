   ...
   !------------------------------------------------------------------------------
    ...
    IF (IsShell) THEN
      BLOCK
        ...
        ALLOCATE( EdgeShell(EdgeCount), EdgeSolidCount(EdgeCount) )
        EdgeShell = 0        
...
!            j = Element % EdgeIndexes(i)
        ...
        CALL Info(Caller,'Number of edges with no shell owners: '//TRIM(I2S(EdgeCount-NoFound)),Level=10)
